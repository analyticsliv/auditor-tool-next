                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-200 p-4">
                  <div className="flex items-start space-x-2">
                    <input
                      ...
                      className="mt-0.5 w-4 h-4 text-purple-600 border-purple-300 rounded focus:ring-purple-500 focus:ring-2 cursor-pointer"
                    />
                    <label htmlFor="ecommerce" className="cursor-pointer flex-1">
                      ...
                      <p className="text-xs text-gray-600 ml-7">
                        Check this if your property tracks online sales, transactions, and product data
                      </p>
                    </label>
                  </div>
                </div>
